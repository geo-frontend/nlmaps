...
@font-face {
    ...
    src: url('@/assets/fonts/montserrat/montserrat-thin.eot?#iefix') format('embedded-opentype'),
        url('@a/ssets/fonts/montserrat/montserrat-thin.woff2') format('woff2'),
...
@font-face {
  ...
  src: url('@/assets/fonts/fontello/fontello.eot?73410984#iefix') format('embedded-opentype'),
       url('@/assets/fonts/fontello/fontello.woff2?73410984') format('woff2'),
       url('@/assets/fonts/fontello/fontello.woff?73410984') format('woff'),
       url('@/assets/fonts/fontello/fontello.ttf?73410984') format('truetype'),
       url('@/assets/fonts/fontello/fontello.svg?73410984#fontello') format('svg');
  font-weight: normal;
  font-style: normal;
}
...
.icon-upvote:before { content: '\e801'; } /* '' */
.icon-target:before { content: '\e802'; } /* '' */
.icon-spin5:before { content: '\e803'; } /* '' */
.icon-precise:before { content: '\e837'; } /* '' */
.icon-embedding:before { content: '\e838'; } /* '' */
.icon-official:before { content: '\e839'; } /* '' */
