...
function v(e) {
  ...
  (!e.layers || e.layers.length < 0) && p("no basemap defined, please define a basemap in the configuration"), e.layers.forEach((o) => {
    (!o.name || n.BASEMAP_PROVIDERS[o.name] !== void 0) && p("basemap names need to be defined and unique: " + o.name), n.BASEMAP_PROVIDERS[o.name] = b(
      d(t, o)
    );
  });
}
function y(e) {
  ...
  e.layers && e.layers.forEach((o) => {
    (!o.name || n.WMS_PROVIDERS[o.name] !== void 0) && p("wms names need to be defined and unique: " + o.name), n.WMS_PROVIDERS[o.name] = w(
      d(t, o)
    );
  });
}
