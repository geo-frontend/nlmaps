...
function Y(e) {
  ...
  ;(!e.layers || e.layers.length < 0) &&
    v('no basemap defined, please define a basemap in the configuration'),
    e.layers.forEach((o) => {
      ;(!o.name || s.BASEMAP_PROVIDERS[o.name] !== void 0) &&
        v('basemap names need to be defined and unique: ' + o.name),
        (s.BASEMAP_PROVIDERS[o.name] = oe(y(t, o)))
    })
}
function X(e) {
  ...
  e.layers &&
    e.layers.forEach((o) => {
      ;(!o.name || s.WMS_PROVIDERS[o.name] !== void 0) &&
        v('wms names need to be defined and unique: ' + o.name),
        (s.WMS_PROVIDERS[o.name] = re(y(t, o)))
    })
}
function ee(e) {
...
function re(e) {
  ...
  if (t > -1) {
    ...
    e.url.slice(t + 1, o).toLowerCase() === 'workspacename'
      ...
      : v('only workspacename templates are supported for now')
  }
  return e
}
function ne(e) {
...
d.doLookupRequest = function (e) {
  return x(`${this.lookupUrl}id=${encodeURIComponent(e)}`).then((t) => {
    ...
    return (
      (o.centroide_ll = P(o.centroide_ll)),
      (o.centroide_rd = P(o.centroide_rd)),
      o
    )
  })
}
d.createControl = function (e, t) {
  ...
  return (
    ...
    n.setAttribute('aria-label', d.placeholder),
    ...
    i.setAttribute('aria-label', d.placeholder),
    b(i, s.CLASSNAMES.geocoderButton),
    (u.id = 'nlmaps-geocoder-control-results'),
    b(u, s.CLASSNAMES.geocoderResultList),
...
const Le = function (e) {
  ...
  return {
    start() {
      return (
        (t.started = !0),
        navigator.geolocation.getCurrentPosition(ge.bind(this), he.bind(this), {
          maximumAge: 6e4,
        }),
        this
      )
  ...
  ;(!e.layers || e.layers.length < 0) &&
    ...
    e.layers.forEach((o) => {
      ;(!o.name || a.BASEMAP_PROVIDERS[o.name] !== void 0) &&
        ...
        (a.BASEMAP_PROVIDERS[o.name] = ve(S(t, o)))
    })
}
function Se(e) {
  ...
  e.layers &&
    e.layers.forEach((o) => {
      ;(!o.name || a.WMS_PROVIDERS[o.name] !== void 0) &&
        ...
        (a.WMS_PROVIDERS[o.name] = Ee(S(t, o)))
    })
}
function be(e) {
...
g.map !== void 0 && ke(g.map)
ye(g.basemaps)
g.wms !== void 0 && Se(g.wms)
g.geocoder !== void 0 && be(g.geocoder)
...
m.doLookupRequest = function (e) {
  return G(`${this.lookupUrl}id=${encodeURIComponent(e)}`).then((t) => {
    const o = t.response.docs[0]
    return (
      (o.centroide_ll = O(o.centroide_ll)),
      (o.centroide_rd = O(o.centroide_rd)),
      o
    )
  })
}
m.createControl = function (e, t) {
  ...
  const o = document.createElement('div'),
    ...
    u = document.createElement('div')
  return (
    k(o, a.CLASSNAMES.geocoderContainer),
    k(r, a.CLASSNAMES.geocoderSearch),
    o.addEventListener('click', (l) => l.stopPropagation()),
    o.addEventListener('dblclick', (l) => l.stopPropagation()),
    (n.id = 'nlmaps-geocoder-control-input'),
    (n.placeholder = m.placeholder),
    n.setAttribute('aria-label', m.placeholder),
    n.setAttribute('type', 'text'),
    n.setAttribute('autocapitalize', 'off'),
    n.setAttribute('autocomplete', 'off'),
    n.setAttribute('autocorrect', 'off'),
    ...
    i.setAttribute('aria-label', m.placeholder),
    k(i, a.CLASSNAMES.geocoderButton),
    (u.id = 'nlmaps-geocoder-control-results'),
    k(u, a.CLASSNAMES.geocoderResultList),
    u.classList.add('nlmaps-hidden'),
    o.appendChild(r),
    r.appendChild(n),
    r.appendChild(i),
...
m.showSuggestResults = function (e) {
  if ((this.clearSuggestResults(), e.length > 0)) {
    ...
    e.forEach((o) => {
      ...
      ;(n.innerHTML = o.weergavenaam),
        (n.id = o.id),
        k(n, a.CLASSNAMES.geocoderResultItem),
        n.setAttribute('href', '#'),
        n.addEventListener('click', (i) => {
          i.preventDefault(), this.lookup(i.target.id)
        }),
...
function Z(e, t, o, r) {
  ...
  if ((n.addTo(e), o)) {
    let i = o.call(p, t, n),
      u = L.popup({ offset: [0, -50] }).setContent(i)
      ...
      i === 0 &&
        r(0, (l, h) => {
          if (l === 1) {
            ...
            Me(F).then((V) => {
              let W = { queryResult: o(V), latlng: h.latlng }
              u(1, W)
            })
          } else u(l, h)
        })
...
function De(e) {
  ...
  return (
    ...
    o.appendChild(r),
    (n.maxBounds = D()),
    (t = L.map(r, n).setView([e.center.latitude, e.center.longitude], e.zoom)),
...
c.createMap = function (e = {}) {
  ...
  const o = De(t),
    r = Ue(t.style)
  if ((_(r, o), t.search && je(o), t.marker)) {
    let n = t.marker
